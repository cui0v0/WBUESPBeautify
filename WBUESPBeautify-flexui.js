...
(function(){
    ...
    function leftMenuWidthOptimize(leftMenu){
    ...
    if(document.querySelector("#LeftMenu1_divChildMenu")){
        ...
        leftMenuWidthOptimize(leftMenu);
    }
    //修复评教页面宽度不为100%
