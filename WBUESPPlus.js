...
(function(){
    ...
    function SimWindowActions(){
        ...
        if(SimWindow.classList.contains("fullscreen")){
            ...
            window.parent.document.querySelector(".mask").classList.add("display_none");
            document.querySelector(".SimFullScreen").innerHTML = zoom_in_icon;
        }else{
            SimWindow.classList.add("fullscreen");
            window.parent.document.querySelector(".mask").classList.remove("display_none");
