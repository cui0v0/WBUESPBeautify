...
(function(){
    ...
    if(document.location.href.includes("cjcx_list")){
        ...
        let filter_panel = special_div_create("filter_panel display_none","");
        ...
        filter_ui_btn.addEventListener("click",()=>{
            filter_panel.classList.toggle("display_none");
        });
        panel_inner.appendChild(semester_picker_panel);
        panel_inner.appendChild(lesson_type_picker_panel);
        filter_panel.appendChild(panel_inner);
        filter_panel.appendChild(filter_btn);
