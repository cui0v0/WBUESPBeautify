...
(function(){
    ...
    function rateOptimize(){
        ...
        if(rate<=0.065){
            document.querySelector("#kbtable").style.zoom = 0.9;
        }
    }
    //fix a width
    if($("*[name='zyxzForm']")[0]){
