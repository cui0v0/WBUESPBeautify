...
(function () {
  $(document).ready(function () {
    ...
    $("body").append($('<style id="SimFooterCSS">.Nsb_rights {height: max-content;line-height: normal;width: inherit;}.info{text-align: center;color: #000;& .heart{color: #ff0081;}}#Footer1_divCopyright{text-align: center;display: inline-flex;width: inherit;bottom: 0;flex-direction: column;}</style>')); //home page css
    ...
    if (document.location.href.includes("cjcx_list")) {
      ...
      var icon_btn = document.createElement("button");
      ...
      var calc_ui_btn = document.createElement("button");
      ...
      calc_ui_btn.addEventListener("click", function () {
      ...
      document.querySelectorAll("td a[style][href]").forEach(function (e) {
        ...
        var JsModData = e.href.slice(e.href.indexOf("JsMod") + 7, e.href.indexOf("%27"));
    ...
    function setup_SimUI() {
      ...
      var pickPanel = special_div_create("pickPanel", "<span>请勾选需要进行计算的学期</span>");
      ...
      SimUI.querySelector(".close_btn").addEventListener("click", function () {
        SimUI.classList.add("display_none");
        mask.classList.add("display_none");
    ...
    function create_semester_pick(semester) {
      ...
      var semester_pick = document.createElement("div");
      semester_pick.className = "semester_pick";
      var semester_text = document.createElement("div");
      ...
      semester_pick.querySelector("svg").addEventListener("click", function (s) {
    ...
    if ($(".kbcontent1")[0]) {
      ...
      (function () {
        ...
        if (!$(".Nsb_layout_r")[0]) {
          var classLists_eg = document.createElement("div");
          classLists_eg.className = "classLists";
          var classLists, tempJson, hslDarker;

          var _tr = document.querySelectorAll("#kbtable tr");

          var _th = _tr[0].children;
          var _length2 = _th.length;
          var tr_length = _tr.length;

          for (var _i7 = 1; _i7 <= _length2; _i7++) {
            if (_th[_i7 - 1].colSpan == 7) {
              _th[_i7 - 1].colSpan = 6;
            }
          }

          var td = _tr[1].children;
          _length2 = td.length;

          for (var _i8 = 1; _i8 <= _length2; _i8++) {
            if (td[_i8 - 1].innerHTML == '13') {
              _length2--;

              for (var o = 2; o <= tr_length; o++) {
                _tr[o - 1].children[_i8 - 1].remove();
              }
            }
          }

          _length2 = $(".kbcontent1").length;

          for (var _i9 = 1; _i9 <= _length2; _i9++) {
          ...
          (function () {
            ...
            var _loop3 = function _loop3(_i11) {
              ...
              if (kbcontent.id != 'SimKB' && kbcontent.innerHTML != '&nbsp;') {
                ...
                while (_o3 < length - 1) {
                  if (cut_judge(childNodes[_o3]) == true) {
                    break;
                  }
                ...
                while (_o3 < length - 1) {
                  if (cut_judge(childNodes[_o3]) == true) {
                    ...
                    childNodes[_o3].remove();

                    length--;
                    cut_times++;
                  }

                  kbdiv.appendChild(childNodes[_o3]);
                  length--;
            ...
            for (var _i11 = 1; _i11 <= kblength; _i11++) {
              _loop3(_i11);
            }
    ...
    if ($(".Nsb_layout_r")[0] && !$(".Nsb_l_list_now")[0]) {
      var _length3 = $("a[href]").length;

      for (var _i13 = 1; _i13 < _length3; _i13++) {
        if ($("a[href]")[_i13 - 1].innerText == $(".Nsb_r_title")[0].innerText) {
          $("a[href]")[_i13 - 1].className += " Nsb_l_list_now";
        }
      }
    }
    ...
    if (document.getElementsByClassName("Nsb_pw")[2] && document.getElementById("btn_back") && document.location.href.includes("cjcx_list")) {
      ...
      var _length4 = childNodes.length;
      var div = document.createElement("div");
      div.id = "SimInfo";

      for (var _i14 = 5; _i14 <= _length4; _i14++) {
        if (childNodes[_i14 - 2].nodeName == 'BR' && childNodes[_i14].nodeName == 'BR') {
          var line1 = document.createElement("div");
          line1.innerHTML = childNodes[_i14 - 1].data;
          div.appendChild(line1);
        }

        if (childNodes[_i14 - 2].nodeName == 'BR' && childNodes[_i14].nodeName == 'SPAN' || childNodes[_i14 - 2].nodeName == 'SPAN' && childNodes[_i14].nodeName == 'SPAN') {
          div.innerHTML += childNodes[_i14 - 1].data;
        }

        if (childNodes[_i14 - 1].nodeName == 'SPAN') {
          var span = childNodes[_i14 - 1].cloneNode(true);
      ...
      for (var _i15 = 1; _i15 <= _length4; _i15++) {
        if ((childNodes[_i15 - 1].nodeName == 'BR' || childNodes[_i15 - 1].nodeName == '#text' || childNodes[_i15 - 1].nodeName == 'SPAN') && childNodes[_i15 - 1].parentElement.id != "SimInfo") {
          childNodes[_i15 - 1].remove();

          _i15 -= 1;
        }

        _length4 = childNodes.length;
      }
    } //fix pattern
    ...
    if (document.getElementsByTagName("input").length > 1) {
      ...
      var _length5 = input.length;

      for (var _i16 = 1; _i16 <= _length5; _i16++) {
        if ((input[_i16 - 1].type == "text" || input[_i16 - 1].type == "password") && input[_i16 - 1].parentElement.tagName == "TD") {
          input[_i16 - 1].className += " SimInput";
        } //marker for disabled input


        if (input[_i16 - 1].disabled == true) {
          input[_i16 - 1].className += " disabled";
        }
      }
    } //select
    ...
    if (document.getElementsByTagName("select")[0]) {
      ...
      var _length6 = select.length;

      for (var _i17 = 1; _i17 <= _length6; _i17++) {
        select[_i17 - 1].className = "SimSelect";
      }
    }
    ...
    if ($("form")[0]) {
      if ($("form")[0].action == "http://jw.wbu.edu.cn/jsxsd/kbxx/jsjy_query2") {
        ...
        var _length7 = _select.length;

        for (var _i18 = 1; _i18 <= _length7; _i18++) {
          _select[_i18 - 1].className += " Slim";
        }

        var _input = document.getElementsByTagName("input");

        _length7 = _input.length;

        for (var _i19 = 1; _i19 <= _length7; _i19++) {
          if (_input[_i19 - 1].type == "text" || _input[_i19 - 1].type == "password" && _input[_i19 - 1].parentElement.tagName == "TD") {
            _input[_i19 - 1].className += " Slim";
          }
        }
      }
    } //SimPage
    ...
    function waitForLoading(targetSelector) {
      return regeneratorRuntime.async(function waitForLoading$(_context) {
        while (1) {
    ...
    if (document.getElementsByClassName("block1")[0]) {
      ...
      var icon6 = document.createElement("span");
      var icon7 = document.createElement("span");
      var icon8 = document.createElement("span");
      var icon9 = document.createElement("span");
      var icon10 = document.createElement("span");
      var icon11 = document.createElement("span");
      var icon12 = document.createElement("span");
      ...
      icon12.className = "iconfont icon-zaixianbaoming"; //fix missing block6
    ...
    if (document.getElementById("Top1_divLoginName")) {
      var name_hide_top = function name_hide_top() {
        if (origin_name_top == name_top.innerHTML) {
          name_top.innerHTML = "个人信息已隐藏";
          Cookies.set('name_top', 'hidden', {
            path: '/'
          });
          Cookies.set('name_inner', 'hidden', {
            path: '/'
          });
        } else {
          name_top.innerHTML = origin_name_top;
          Cookies.remove('name_top', {
            path: '/'
          });
          Cookies.remove('name_inner', {
            path: '/'
          });
        }
      };

      var name_hide_inner = function name_hide_inner() {
      ...
      var name_hide = function name_hide() {
    ...
    if (document.getElementById("Footer1_divCopyright")) {
      ...
      footer.className = "";
      footer.style = ""; // let info = document.createElement("div");
    ...
    if (document.getElementsByTagName("Form")[1] && document.getElementsByTagName("input")[0]) {
      ...
      if (form[form.length - 1].getElementsByClassName("Nsb_r_title")[0]) {
        ...
        if ($(".Nsb_layout_r")[0]) {
          for (var _i20 = 1; _i20 <= btn_len; _i20++) {
            if (btn[_i20 - 1].getAttribute("onclick")) {
              validLength++;
            }
          }
          ...
          if (validLength >= 3) {
            for (var _i21 = 1; _i21 <= btn_len; _i21++) {
              if (btn[_i21 - 1].getAttribute("onclick")) {
                buttons.appendChild(btn[_i21 - 1]);
              }
            }
          }
        } else {
    ...
    if (document.getElementById("kbtable")) {
      ...
      var _tr2 = _table.getElementsByTagName("tr");

      var _th2 = _tr2[0].getElementsByTagName("th");

      _th2[0].className += " thb_t_l";
      _th2[_th2.length - 1].className += " thb_t_r";
      var _tr_c = _tr2[_tr2.length - 1].children;
