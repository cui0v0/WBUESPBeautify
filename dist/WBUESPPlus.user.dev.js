...
(function () {
  $(document).ready(function () {
    ...
    function spring_festival() {
      ...
      if (!document.getElementById("SimPage") && window.parent.document.getElementById("SimPage")) {} else {
    ...
    if (document.documentURI.includes("xspj_edit.do?")) {
      var autoClick = function autoClick(index) {
        document.querySelectorAll("#table1 tr td:not([align])").forEach(function (e) {
      ...
      var unlimited = document.createElement("script");
      ...
      document.querySelectorAll("#table1 tr td:not([align])").forEach(function (e) {
        e.querySelectorAll("input[type=radio]").forEach(function (i) {
          i.addEventListener("dblclick", function () {
            var index = i.id.slice(i.id.length - 1);
      ...
      var pjBtn = document.createElement("input");
      pjBtn.setAttribute("value", "一键评优");
      pjBtn.setAttribute("type", "button");
      pjBtn.classList.add("button");
      pjBtn.id = "SimBtn";
      pjBtn.style.cssText = "position: fixed;bottom: 1rem;z-index: 100;right: 1rem;";
      pjBtn.addEventListener("click", function () {
        autoClick(0);
      });
      document.body.appendChild(pjBtn);
    ...
    if (document.querySelector("#LeftMenu1_divChildMenu")) {
      var leftMenu = document.querySelector("#LeftMenu1_divChildMenu");
    ...
    if (document.location.href.includes("comeXkjglb") || document.location.href.includes("comeInXxxk")) {
      if (document.body.clientHeight <= document.body.scrollHeight) {
        var rate = document.body.clientHeight / document.body.scrollHeight;
        document.body.style.zoom = rate;
      }
    }

    if (document.location.href.includes("xsxk_index")) {
      document.body.classList.add("SimHalf");
      document.querySelector("div.tabContext").style.height = "";
      document.querySelectorAll("iframe[frameborder][src]").forEach(function (e) {
        e.style.height = "100%";
      });
      document.querySelector("iframe#mainFrame").parentElement.parentElement.style.flexBasis = "40%";
      document.querySelector("iframe#mainFrame").parentElement.parentElement.style.marginBottom = "2rem";
      document.querySelector("iframe#kbFrame").parentElement.parentElement.style.flexBasis = "50%";
    }

    if (document.querySelector("input.button[onclick='exitXk()']")) {
      var exitBtn = document.querySelector("input.button[onclick='exitXk()']");
      var name = document.createElement("div");
      name.innerText = window.sessionStorage.getItem("userName");
    ...
    function sidebarActions() {
      var arrow_text = document.querySelector("#LeftMenu1_divChildMenu.sidebar .arrow .text");
      var sidebar = document.querySelector("#LeftMenu1_divChildMenu.sidebar");
    ...
    function leftMenuWidthOptimize() {
      ...
      if (!document.querySelector("div.arrow")) {
        ...
        var arrow_text = document.createElement("div");
    ...
    function svgReplacement(table) {
      if (table.querySelector("img[src='../framework/images/rq.png']")) {
        var imgRq = table.querySelector("img[src='../framework/images/rq.png']");
    ...
    function rateOptimize() {
      var actualWidth = document.querySelector("#kbtable tbody").clientWidth;
      var kbtableWidth = document.querySelector("#kbtable").clientWidth;
      var rate = kbtableWidth / actualWidth;
    ...
    if (document.location.href.includes("cjcx_list")) {
      ...
      var simGrid = document.createElement("div");
      simGrid.className = "SimGrid";
      document.querySelectorAll("td a[style][href]").forEach(function (e) {
        var subject = {};
        ...
        var JsModData = e.href.indexOf("%27") != -1 ? e.href.slice(e.href.indexOf("JsMod") + 7, e.href.indexOf("%27")) : e.href.slice(e.href.indexOf("JsMod") + 7, e.href.lastIndexOf("'"));
      ...
      var icon_btn = create_specific_element("button", "", "icon_btn", "button");
      var noresult_tip = create_specific_element("div", "无符合筛选条件的结果", "noresult", "display_none");
      ...
      icon_btn.addEventListener("click", function () {
        if (icon_btn.querySelector("span").innerText == "网格显示") {
          ...
          icon_btn.querySelector("svg").innerHTML = grid_display_icon;
          icon_btn.querySelector("span").innerText = "网格显示";
          noresult_tip.classList.add("grid_form");
        }
      });
      var calc_ui_btn = create_specific_element("button", "<svg t=\"1720522001969\" class=\"icon\" style=\"margin-left: 5px;\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"10291\" width=\"20\" height=\"20\">" + calc_ui_icon + "</svg><span style=\"font-size: 1rem;\">\u7EFC\u6D4B\u6210\u7EE9\u8BA1\u7B97\u5668</span>", "calc_ui_btn", "button");
      calc_ui_btn.addEventListener("click", function _callee() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return regeneratorRuntime.awrap(asyncSleep(10));
      ...
      var filter_outer_div = document.createElement("div");
      var filter_ui_btn = create_specific_element("div", "<svg class=\"icon\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"8534\" width=\"20\" height=\"20\" style=\"margin-left:3px\">" + filter_empty_icon + "</svg><span>筛选</span>", "filter_ui_btn", "button");
      var filter_panel = create_specific_element("div", "", "filter_panel", "folded");
      var panel_body = create_specific_element("div", "", "panel_body");
      var panel_inner = create_specific_element("div", "", "inner");
      var semester_picker_panel = create_specific_element("div", "<span>学期</span>", "pickPanel");
      semester_list.forEach(function (e) {
        var picker_option = create_picker_option("picker_option", "text", e);
        picker_option.classList.add("filter_semester");
        semester_picker_panel.appendChild(picker_option);
      });
      var lesson_type_picker_panel = create_specific_element("div", "<span>课程属性</span>", "pickPanel");
      ...
      lesson_type_picker_panel.querySelectorAll(".picker_option").forEach(function (e) {
        e.classList.add("filter_lesson_type");
      });
      var filter_btn = create_specific_element("button", "筛选", "filter_btn", "button");
      filter_btn.addEventListener("click", function () {
        filter_panel.querySelectorAll(".picker_option").forEach(function (e) {
          filter_function(e.querySelector("svg.icon"), e.querySelector(".text").innerText);
        });

        if (filter_panel.querySelector(".picker_option svg.checked")) {
          filter_ui_btn.querySelector("svg").innerHTML = filtered_icon;
        } else {
          filter_ui_btn.querySelector("svg").innerHTML = filter_empty_icon;
        }

        document.querySelectorAll("#dataList tr:not(:last-child)").forEach(function (e) {
          e.firstElementChild.classList.remove("thb_b_l");
          e.lastElementChild.classList.remove("thb_b_r");
        });

        if (document.querySelectorAll("#dataList tr:not(.display_none)").length > 1) {
          document.querySelectorAll("#dataList tr:not(.display_none)")[document.querySelectorAll("#dataList tr:not(.display_none)").length - 1].firstElementChild.classList.add("thb_b_l");
          document.querySelectorAll("#dataList tr:not(.display_none)")[document.querySelectorAll("#dataList tr:not(.display_none)").length - 1].lastElementChild.classList.add("thb_b_r");
        }

        if (document.querySelectorAll(".grid").length == document.querySelectorAll(".grid.display_none").length) {
          noresult_tip.classList.remove("display_none");

          if (icon_btn.querySelector("span").innerText == "网格显示") {
            noresult_tip.classList.add("grid_form");
          }
        } else {
          noresult_tip.classList.add("display_none");
          noresult_tip.classList.remove("grid_form");
        }

        filter_ui_btn.querySelector(".count") ? filter_ui_btn.querySelector(".count").remove() : "";
        var count = create_specific_element("div", "(" + document.querySelectorAll(".grid:not(.display_none)").length + ")", "count");
      ...
      var back_btn = create_specific_element("button", "", "back_btn", "button");
      back_btn.innerText = "收起";
      back_btn.classList.add("below");
      back_btn.addEventListener("click", function () {
        filter_panel.classList.add("folded");
      });

      back_btn.ontransitionend = function (te) {
        if (te.propertyName == "border-bottom-left-radius" && te.target.parentElement.classList.contains("folded")) {
          te.target.classList.add("below");
        }
      };

      back_btn.ontransitionstart = function (te) {
        if (te.propertyName == "width" && te.target.clientWidth < document.querySelector(".filter_panel").clientWidth) {
          te.target.classList.remove("below");
        }
      };

      filter_ui_btn.addEventListener("click", function () {
        filter_panel.classList.remove("folded");
      });
      panel_inner.appendChild(semester_picker_panel);
      panel_inner.appendChild(lesson_type_picker_panel);
      filter_panel.appendChild(back_btn);
      panel_body.appendChild(panel_inner);
      panel_body.appendChild(filter_btn);
      filter_panel.appendChild(panel_body);
      filter_outer_div.appendChild(filter_ui_btn);
      filter_outer_div.appendChild(filter_panel);
      buttonsDiv.appendChild(icon_btn);
      buttonsDiv.appendChild(calc_ui_btn);
      buttonsDiv.appendChild(filter_outer_div);
      document.querySelector(".Nsb_r_title").after(buttonsDiv);
      document.querySelector("table#dataList").after(simGrid);
      simGrid.after(noresult_tip);
    ...
    if (document.querySelector("#kbtable") && window.parent.document.querySelector("iframe#fcenter")) {
      ...
      document.querySelector("#kbtable").classList.add("insideIframe"); // let weeklyTopBar = special_div_create("weeklyTopBar","");
      // weeklyTopBar.style.width = document.querySelector("#kbtable tr").clientWidth+"px";
      // document.querySelectorAll("#kbtable th").forEach((e)=>{
      //     let topBarCell = special_div_create("cell"+e.className,e.innerText);
      //     topBarCell.style.width = e.clientWidth-34+"px";
      //     weeklyTopBar.appendChild(topBarCell);
      // });
      // document.body.appendChild(weeklyTopBar);

      if (!document.querySelector(".SimFullScreen")) {
        var SimFullScreenBtn = create_specific_element("div", zoom_in_icon, "button", "SimFullScreen");
      ...
      if (!window.parent.document.querySelector(".mask")) {
        var SimMask = create_specific_element("div", "", "mask", "display_none", "hidden");
    ...
    if (document.getElementsByClassName("Nsb_table")[0]) {
      var table = document.getElementsByClassName("Nsb_table");
      ...
      if (!document.getElementById("kbtable")) {
        for (var i = 1; i <= length; i++) {
          ...
          var tr = table[i - 1].getElementsByTagName("tr");
          ...
          var tr_c = tr[tr.length - 1].children;
    ...
    function SimWindowActions() {
      var SimWindow, SimMask;
      return regeneratorRuntime.async(function SimWindowActions$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              SimWindow = window.parent.document.querySelector(".SimWindow");
              SimWindow.style.top = window.parent.document.body.clientHeight + "px";
              SimMask = window.parent.document.querySelector(".mask");
              ...
              _context2.next = 9;
              return regeneratorRuntime.awrap(asyncSleep(300));
    ...
    function create_grid(title, score, time, id, credit, type, semester, JsModData) {
      ...
      if (title.length >= 15) {
        ...
        grid_item.onmouseenter = function () {
          var extra = 20 - (title.length - 15 - 2);
    ...
    function setup_SimUI() {
      var SimUI = create_specific_element("div", "", "display_none", "hidden");
      SimUI.id = "SimUI";
      SimUI.innerHTML = "<div class=\"top\"><div class=\"title\">\u7EFC\u6D4B\u6210\u7EE9\u8BA1\u7B97\u5668</div><button class=\"close_btn button\">\xD7</button></div><div class=\"desc\">\u7528\u4E8E\u8BA1\u7B97\u9009\u5B9A\u5B66\u671F\u7684\u7EFC\u6D4B\u5206\u6570</div>";
      var pickPanel = create_specific_element("div", "<span>请勾选需要进行计算的学期</span>", "pickPanel");
      SimUI.appendChild(pickPanel);
      semester_list.forEach(function (e) {
        pickPanel.appendChild(create_picker_option("picker_option", "text", e));
      });
      var mask = create_specific_element("div", "", "mask", "display_none", "hidden");
      var scorePanel = create_specific_element("", "", "scorePanel");
      var calc_btn = create_specific_element("button", "计算", "button");
      calc_btn.addEventListener("click", function () {
        if (!pickPanel.querySelector("svg.checked")) {
          window.alert("请选择要计算的学期！");
        } else {
          selected_semesters = [];
          pickPanel.querySelectorAll("svg.checked").forEach(function (e) {
            selected_semesters.push(e.parentElement.querySelector(".text").innerText);
          });
          console.log(selected_semesters);
          var filtered_subjects = subject_info.filter(function (e) {
            return selected_semesters.includes(e.semester);
          });
          console.log(filtered_subjects);
          var semesters_text = "";

          for (var _i = 1; _i <= selected_semesters.length; _i++) {
            semesters_text += selected_semesters[_i - 1];

            if (_i < selected_semesters.length) {
              semesters_text += "，";
            }
          }
      ...
      SimUI.querySelector(".close_btn").addEventListener("click", function _callee2() {
        return regeneratorRuntime.async(function _callee2$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                SimUI.classList.add("hidden");
                mask.classList.add("hidden");
                _context3.next = 4;
                return regeneratorRuntime.awrap(asyncSleep(295));
    ...
    function create_specific_element(tagName, innerHTML) {
      tagName !== "" ? tagName : tagName = "div";
      var ele = document.createElement(tagName);

      for (var _len = arguments.length, classListItems = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
        classListItems[_key - 2] = arguments[_key];
      }

      if (classListItems.length == 1) {
        ele.className = classListItems[0];
      } else {
        classListItems.forEach(function (e) {
          ele.classList.add(e);
        });
      }
    ...
    function create_picker_option(option_class, text_class, text) {
      ...
      var option_text = document.createElement("div");
      option_text.className = text_class;
      option_text.innerText = text;
      option.innerHTML = "<svg t=\"1720512177671\" class=\"icon\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"4233\" width=\"30\" height=\"30\">" + checkbox_icon + "</svg>";
      option.appendChild(option_text);
      option.querySelector("svg").addEventListener("click", function (s) {
    ...
    var filter_hidden_options = ["filter_semester", "filter_lesson_type"]; //checkbox -> checkbox,filter_by -> 筛选条件

    function filter_function(checkbox, filter_by) {
      filter_by = isNaN(filter_by[0]) ? filter_by : "s" + filter_by;

      if (!checkbox.classList.contains("checked")) {
        document.querySelectorAll("." + filter_by).forEach(function (e) {
          e.classList.add(checkbox.parentElement.classList[1]); //checkbox.parentElement的定义，filter_semester/filter_lesson_type

          e.classList.add("display_none");

          if (!checkbox.parentElement.parentElement.querySelector("svg.checked")) {
            e.classList.remove(checkbox.parentElement.classList[1]);

            if (!e.classList.contains(filter_hidden_options[0]) && !e.classList.contains(filter_hidden_options[1])) {
        ...
        document.querySelectorAll("." + filter_by).forEach(function (e) {
          if (e.classList.contains(checkbox.parentElement.classList[1])) {
            e.classList.remove(checkbox.parentElement.classList[1]);
          }
    ...
    document.body.style.width = "-webkit-fill-available"; //去除前后方括号
      ...
      document.querySelectorAll("td a[href]").forEach(function (e) {
        if (e.previousSibling) {
          if (e.previousSibling.nodeValue) {
            var value = e.previousSibling.nodeValue.replaceAll("\t", "");
        ...
        if (e.nextSibling) {
          if (e.nextSibling.nodeValue) {
            var _value = e.nextSibling.nodeValue.replaceAll("\t", "");
            ...
            if (_value == "]" || e.nextSibling.nodeValue == "]\n\t\t\t\t\n\t\t\t\t") {
              e.nextSibling.remove();
            }
          }
        }
    ...
    if ($("#dataList")[0]) {
      var thb = $("#dataList")[0].getElementsByClassName("Nsb_r_list_thb");
      var _length = thb.length;

      for (var _i2 = 1; _i2 <= _length; _i2++) {
        if (thb[_i2 - 1].style.width != '') {
          thb[_i2 - 1].style.width = '';
        }
      }
    }
    ...
    function foolsdayFunc() {
      ...
      var day = now.getDay();
      var studentNum = "2" + year.toString() + "0401";
    ...
    function randomColorPick() {
      ...
      hue_list.push(hue);
      var sat = getRandomIntInclusive(85, 100);
      var light = getRandomIntInclusive(38, 42);
    ...
    function fixKBBottom(type) {
      var td = $("#kbtable")[0].getElementsByTagName("td");
      var length = td.length;

      for (var _i3 = 1; _i3 <= length; _i3++) {
        var kbcontent = td[_i3 - 1].getElementsByClassName(type);
    ...
    function SimStackActions() {
      var SimStack = this.parentElement.getElementsByClassName('SimStack');
      var length = SimStack.length;
      var tempJson;
      ...
      var hslDarker = "hsl(" + tempJson.hue + ", " + tempJson.sat + "%, " + (tempJson.light - 8) + "%)";
      var hslDarker2 = "hsl(" + tempJson.hue + ", " + tempJson.sat + "%, " + (tempJson.light - 16) + "%)";

      for (var _i4 = 1; _i4 <= length; _i4++) {
        if (this.getAttribute('stacked') == 'true') {
          this.style.removeProperty('box-shadow');

          SimStack[_i4 - 1].setAttribute('stacked', 'false');

          SimStacked(SimStack[_i4 - 1]);
          ...
          SimStack[_i4 - 1].setAttribute('stacked', 'true');
    ...
    function setupScalingPanel() {
      ...
      var SimScaleInput = document.createElement('input');
      ...
      var zoomOut = zoomIn.cloneNode(false);
      zoomIn.value = '+';
      zoomIn.id = 'zoomIn';
      zoomOut.value = '–';
      zoomOut.id = 'zoomOut';
    ...
    function universalScaleCtrl(zoomData) {
      ...
      if (!$(".Nsb_layout_r")[0]) {
        var bodyStyle = $("#kbtable")[0].parentElement.style;
    ...
    function scheduleDaysDivision() {
      var colSpan = 0;
      document.querySelectorAll("#kbtable th").forEach(function (e) {
    ...
    function ctrlButtonSetup() {
      document.querySelectorAll("#kbtable th").forEach(function (e) {
        if (e.innerText.includes("星期")) {
          e.addEventListener("click", function (day) {
            day = day.currentTarget;

            if (day.cellIndex >= 1) {
              var startIndex = (day.cellIndex - 1) * day.colSpan + 1;
              var endIndex = startIndex + day.colSpan - 1;
              day.classList.toggle("display_none");
              document.querySelectorAll("#kbtable tr").forEach(function (tr) {
                for (var _i5 = startIndex; _i5 <= endIndex; _i5++) {
                  if (tr.children[_i5].nodeName == "TD") {
                    tr.children[_i5].classList.toggle("display_none");
                  }
                }
              });
            }
    ...
    function getSchedule() {
      var allSchedules = [];
      var tr = document.querySelectorAll("#kbtable tr");

      var _loop = function _loop(_i6) {
        var colSpan = tr[0].querySelector("th[colspan]").colSpan;
        var weeklySchedule = [];
        weeklySchedule.title = tr[_i6].firstElementChild.innerText;
        var dailySchedule = [];
        var dayTemp = 0;

        var _loop2 = function _loop2(j) {
          var lesson_time = j - Math.floor(j / colSpan) * colSpan - 1;

          if (Math.floor(j / colSpan) - dayTemp >= 1) {
            dayTemp += 1;
          ...
          tr[_i6].children[j].querySelectorAll(".kbcontent1").forEach(function (kbcontent) {
            var lesson = {};
            kbcontent.childNodes.forEach(function (cn) {
              if (cn.nodeName == '#text') {
                if (cn.nodeValue.includes("周")) {
                  lesson.time = cn.nodeValue.slice(cn.nodeValue.indexOf("("));
                  var front_text = cn.nodeValue.slice(0, cn.nodeValue.indexOf("(")).replaceAll("\n", "");

                  if (!isNaN(front_text.slice(0, 1))) {
                    lesson["class"] = front_text;
                  } else if (front_text.length > 1) {
                    lesson.teacher = front_text;
                  }
                } else if (cn.nodeValue.includes("－") || cn.nodeValue.includes("北") || cn.nodeValue.includes("东") || cn.nodeValue.includes("南") || cn.nodeValue.includes("西") || cn.nodeValue.includes("体育") || cn.nodeValue.includes("大学生活动中心") || cn.nodeValue.includes("校外") || cn.nodeValue.includes("线上")) {
                  lesson.location = cn.nodeValue.replaceAll("\n", "");
                } else if (!isNaN(cn.nodeValue.slice(2, 3))) {
                  lesson["class"] = cn.nodeValue.replaceAll("\n", "");
                } else if (cn.parentElement.firstChild == cn) {
                  lesson.lesson = cn.nodeValue;
                }
              }
            });

            if (tr[_i6].children[j].querySelectorAll(".kbcontent1").length > 1) {
              lessons.push(lesson);
              dailySchedule[lesson_time] = lessons;
            } else {
              dailySchedule[lesson_time] = lesson;
            }
          });
        };

        for (var j = 1; j < tr[_i6].children.length; j++) {
          _loop2(j);
        }

        allSchedules.push(weeklySchedule);
      };

      for (var _i6 = 2; _i6 < tr.length; _i6++) {
        _loop(_i6);
      }
    ...
    if ($(".kbcontent1")[0]) {
      ...
      (function () {
        var kbcontent, kbcontent1;
        kbsort = new Array();
        hue_list = [];

        if (!$(".Nsb_layout_r")[0]) {
          (function () {
            var classLists_eg = create_specific_element("div", "", "classLists");
            var classLists, tempJson;
            var tr = document.querySelectorAll("#kbtable tr");
            var th = tr[0].children;

            for (var _i7 = 1; _i7 <= th.length; _i7++) {
              if (th[_i7 - 1].colSpan == 7) {
                th[_i7 - 1].colSpan = 6;
              }
            }

            for (var _i8 = 1; _i8 <= tr[1].children.length; _i8++) {
              if (tr[1].children[_i8 - 1].innerHTML == '13') {
                tr[1].children.length--;

                for (var o = 2; o <= tr.length; o++) {
                  tr[o - 1].children[_i8 - 1].remove();
                }
              }
            }

            for (var _i9 = 1; _i9 <= $(".kbcontent1").length; _i9++) {
              classLists = classLists_eg.cloneNode(true);
              kbcontent1 = $(".kbcontent1")[_i9 - 1];

              if (!kbsort[kbcontent1.childNodes[0].data]) {
                kbsort[kbcontent1.childNodes[0].data] = randomColorPick();
              }

              var kbc1Children = kbcontent1.parentElement.children;

              if (kbcontent1 == kbc1Children[0]) {
                var similarity = 0;
                var similarClass = void 0,
                    initalIndex = void 0;

                for (var _o = 1; _o < kbc1Children.length; _o++) {
                  if (kbc1Children[_o - 1].firstChild.data == kbc1Children[_o].firstChild.data && kbc1Children[_o - 1].childNodes[2].data.slice(kbc1Children[_o - 1].childNodes[2].data.lastIndexOf("(")) == kbc1Children[_o].childNodes[2].data.slice(kbc1Children[_o].childNodes[2].data.lastIndexOf("("))) {
                    if (similarity == 0) {
                      similarClass = kbc1Children[_o - 1].childNodes[0].data;
                      initalIndex = _o - 1;
                    }
                ...
                if (similarity > 2) {
                  ...
                  var _hslDarker = "hsl(" + tempJson.hue + ", " + tempJson.sat + "%, " + (tempJson.light - 8) + "%)";

                  var hslDarker2 = "hsl(" + tempJson.hue + ", " + tempJson.sat + "%, " + (tempJson.light - 16) + "%)";

                  for (var _o2 = initalIndex + 2; _o2 <= kbc1Children.length; _o2++) {
                    if (similarClass == kbc1Children[_o2 - 1].firstChild.data) {
                      kbc1Children[_o2 - 1].classList.add('SimStack');

                      kbc1Children[_o2 - 1].setAttribute("stacked", "true");

                      SimStacked(kbc1Children[_o2 - 1]);
                    }
                  }

                  kbc1Children[initalIndex].setAttribute("stacked", "true");
                  kbc1Children[initalIndex].style.cssText += "box-shadow: 3px 3px 0px 1px " + _hslDarker + ", 7px 7px 0px 1px " + hslDarker2;
                  kbc1Children[initalIndex].addEventListener("click", SimStackActions);
                }
              }

              tempJson = kbsort[kbcontent1.childNodes[0].data];
              var tempData = kbcontent1.childNodes[0].data;
              ...
              if (classLists.innerHTML.search(",") != -1) {
                if (classLists.innerHTML.lastIndexOf(",") > classLists.innerHTML.lastIndexOf("(") && classLists.innerHTML.slice(classLists.innerHTML.indexOf(","), classLists.innerHTML.lastIndexOf(",") + 1).indexOf(")") == -1) {} else {
                  if (classLists.innerHTML.lastIndexOf(",") > classLists.innerHTML.lastIndexOf("(")) {
                    var replaced = classLists.innerHTML.slice(0, classLists.innerHTML.lastIndexOf("(")).replaceAll(",", "<br>");
              ...
              if (kbcontent1.lastChild.data.search(",") != -1 && kbcontent1.lastChild.data.slice(0, kbcontent1.lastChild.data.lastIndexOf("(")).search(/[0-9]/) != -1) {
                kbcontent1.lastChild.remove();
                kbcontent1.lastChild.after(classLists);
              } else if (kbcontent1.firstChild.data.search(",") != -1 && kbcontent1.firstChild.data.slice(0, kbcontent1.firstChild.data.lastIndexOf("(")).search(/[0-9]/) != -1) {
              ...
              } else if (kbcontent1.childNodes[2].data.search(",") != -1 && kbcontent1.childNodes[2].data.slice(0, kbcontent1.childNodes[2].data.lastIndexOf("(")).search(/[0-9]/) != -1) {
            ...
            var detail_desc = create_specific_element("div", "<span class='header'>选中的课程节次</span><span class='class'>班级</span><span class='section'>星期 节次</span>", "detail_desc", "hidden");
            document.querySelector("body").appendChild(detail_desc);

            var _loop3 = function _loop3(_i10) {
              var _loop4 = function _loop4(j) {
                var this_td = tr[_i10 - 1].children[j - 1];
                this_td.addEventListener("click", function () {
                  document.querySelectorAll(".chosen").forEach(function (e) {
                    if (e != this_td) e.classList.remove("chosen");
                  });
                  if (detail_desc.classList.contains("hidden")) detail_desc.classList.remove("hidden");

                  if (this_td.classList.contains("chosen")) {
                    this_td.classList.remove("chosen");
                    detail_desc.classList.add("hidden");
                  } else {
                    this_td.classList.add("chosen");
                    detail_desc.classList.remove("hidden");
                  }

                  detail_desc.querySelector(".class").innerText = tr[_i10 - 1].firstElementChild.innerText;
              ...
              for (var j = 2; j <= tr[_i10 - 1].children.length; j++) {
                _loop4(j);
              }
            };

            for (var _i10 = 3; _i10 <= tr.length; _i10++) {
              _loop3(_i10);
            }

            fixKBBottom("kbcontent1");
            setupScalingPanel();
            scheduleDaysDivision(); // if(document.location.href.includes("kbxx_xzb")){
            //     getSchedule();
            // }
          })();
        } else {
          (function () {
            ...
            var kblength = $(".kbcontent").length;
            var length = $(".kbcontent1").length;

            for (var _i11 = 1; _i11 <= length; _i11++) {
              kbcontent1 = $(".kbcontent1")[_i11 - 1];
              kbcontent1.style.display = "none";
            }

            var _loop5 = function _loop5(_i12) {
              var childNodes = void 0;
              kbcontent = $(".kbcontent")[_i12 - 1];
              childNodes = kbcontent.childNodes;
              length = childNodes.length;
              var kbdiv_eg = document.createElement("div");
            ...
            for (var _i12 = 1; _i12 <= kblength; _i12++) {
              _loop5(_i12);
            }

            var th, second, fourth, noon, evening;
            length = $("th").length;
    ...
    if (document.getElementsByClassName("Nsb_r_title")[0]) {
      var title = document.getElementsByClassName("Nsb_r_title")[0];
    ...
    if ($(".Nsb_layout_r")[0] && !$(".Nsb_l_list_now")[0]) {
      var _length2 = $("a[href]").length;

      for (var _i14 = 1; _i14 < _length2; _i14++) {
        if ($("a[href]")[_i14 - 1].innerText == $(".Nsb_r_title")[0].innerText) {
          $("a[href]")[_i14 - 1].className += " Nsb_l_list_now";
        }
      }
    }
    ...
    if (document.getElementsByClassName("Nsb_pw")[2] && document.getElementById("btn_back") && document.location.href.includes("cjcx_list")) {
      var childNodes = document.getElementsByClassName("Nsb_pw")[2].childNodes;
      var _length3 = childNodes.length;
      var div = document.createElement("div");
      div.id = "SimInfo";

      for (var _i15 = 5; _i15 <= _length3; _i15++) {
        if (childNodes[_i15 - 2].nodeName == 'BR' && childNodes[_i15].nodeName == 'BR') {
          var line1 = document.createElement("div");
          line1.innerHTML = childNodes[_i15 - 1].data;
          div.appendChild(line1);
        }

        if (childNodes[_i15 - 2].nodeName == 'BR' && childNodes[_i15].nodeName == 'SPAN' || childNodes[_i15 - 2].nodeName == 'SPAN' && childNodes[_i15].nodeName == 'SPAN') {
          div.innerHTML += childNodes[_i15 - 1].data;
        }

        if (childNodes[_i15 - 1].nodeName == 'SPAN') {
          var span = childNodes[_i15 - 1].cloneNode(true);
      ...
      for (var _i16 = 1; _i16 <= _length3; _i16++) {
        if ((childNodes[_i16 - 1].nodeName == 'BR' || childNodes[_i16 - 1].nodeName == '#text' || childNodes[_i16 - 1].nodeName == 'SPAN') && childNodes[_i16 - 1].parentElement.id != "SimInfo") {
          childNodes[_i16 - 1].remove();

          _i16 -= 1;
        }

        _length3 = childNodes.length;
      }
    } //fix pattern
    ...
    if (document.getElementsByTagName("input").length > 1) {
      ...
      var _length4 = input.length;

      for (var _i17 = 1; _i17 <= _length4; _i17++) {
        if ((input[_i17 - 1].type == "text" || input[_i17 - 1].type == "password") && input[_i17 - 1].parentElement.tagName == "TD") {
          input[_i17 - 1].className += " SimInput";
        } //marker for disabled input


        if (input[_i17 - 1].disabled == true) {
          input[_i17 - 1].className += " disabled";
        }
      }
    } //select
    ...
    if (document.getElementsByTagName("select")[0]) {
      ...
      var _length5 = select.length;

      for (var _i18 = 1; _i18 <= _length5; _i18++) {
        select[_i18 - 1].className = "SimSelect";
      }
    }
    ...
    if ($("form")[0]) {
      if ($("form")[0].action == "http://jw.wbu.edu.cn/jsxsd/kbxx/jsjy_query2") {
        ...
        var _length6 = _select.length;

        for (var _i19 = 1; _i19 <= _length6; _i19++) {
          _select[_i19 - 1].className += " Slim";
        }

        var _input = document.getElementsByTagName("input");

        _length6 = _input.length;

        for (var _i20 = 1; _i20 <= _length6; _i20++) {
          if (_input[_i20 - 1].type == "text" || _input[_i20 - 1].type == "password" && _input[_i20 - 1].parentElement.tagName == "TD") {
            _input[_i20 - 1].className += " Slim";
          }
        }
      }
    } //SimPage
    ...
    document.querySelectorAll("head script[language=javascript]").forEach(function (e) {
    ...
    if (document.querySelector(".toolstitle")) {
      if (!document.querySelector("table#dataList")) {
        if (document.querySelector("input")) {
          waitForLoading(".button").then(function () {
    ...
    function waitForLoading(targetSelector) {
      return regeneratorRuntime.async(function waitForLoading$(_context4) {
        while (1) {
    ...
    function resizeRate() {
      var scale = document.querySelector("div#divFirstMenuClass ul").clientWidth / document.querySelector("body div.wap").clientWidth;
    ...
    if (document.getElementsByClassName("block1")[0]) {
      var apply_icons = function apply_icons(b, i) {
        document.getElementsByClassName(b)[0].appendChild(i);
      };

      GM_addStyle(GM_getResourceText("icon"));
      var icon1 = create_specific_element("span", "", "iconfont icon-yonghu");
      var icon2 = create_specific_element("span", "", "iconfont icon-xuanke");
      var icon3 = create_specific_element("span", "", "iconfont icon-pingjiao");
      var icon4 = create_specific_element("span", "", "iconfont icon-jiejuefangan");
      var icon5 = create_specific_element("span", "", "iconfont icon-icon-test");
      var icon6 = create_specific_element("span", "", "iconfont icon-gonggao-xianxing");
      var icon7 = create_specific_element("span", "", "iconfont icon-chengji");
      var icon8 = create_specific_element("span", "", "iconfont icon-rili");
      var icon9 = create_specific_element("span", "", "iconfont icon-jihua");
      var icon10 = create_specific_element("span", "", "iconfont icon-chengji");
      var icon11 = create_specific_element("span", "", "iconfont icon-xuejiyidongguanli");
      var icon12 = create_specific_element("span", "", "iconfont icon-zaixianbaoming"); //fix missing block6
      ...
      apply_icons("block12", icon12); //add title for hide names func
    ...
    if (document.getElementById("Top1_divLoginName")) {
      var name_hide_func = function name_hide_func() {
      ...
      var name_top = document.getElementById("Top1_divLoginName");
      var origin_name_top = name_top.innerText;
      ...
      var name_inner, origin_name_inner;
      var version_info = "WBUESPPlus版本:<br>" + GM_info.script.version;
    ...
    foolsdayFunc(); //add title for hide names func

    if (document.getElementById("Footer1_divCopyright")) {
      var footer = document.getElementById("Footer1_divCopyright");
      footer.className = "";
      footer.style = "";
      var info = create_specific_element("div", "Beautified with <span class='heart'>❤</span><span class='info'> by Simprole</span><br><span class='info'>了解更多：<a href='https://gitee.com/dmaker/WBUESPPlus' target='_blank;'>https://gitee.com/dmaker/WBUESPPlus</a></span>", "info");
    ...
    if (document.getElementsByTagName("Form")[1] && document.getElementsByTagName("input")[0]) {
      ...
      if (form[form.length - 1].getElementsByClassName("Nsb_r_title")[0]) {
        ...
        var btn = form[form.length - 1].getElementsByTagName("input");
        var btn_len = btn.length;
        var validLength = 0;

        if ($(".Nsb_layout_r")[0]) {
          for (var _i21 = 1; _i21 <= btn_len; _i21++) {
            if (btn[_i21 - 1].getAttribute("onclick")) {
              validLength++;
            }
          }

          if (validLength >= 3) {
            for (var _i22 = 1; _i22 <= btn_len; _i22++) {
              if (btn[_i22 - 1].getAttribute("onclick")) {
                buttons.appendChild(btn[_i22 - 1]);
              }
            }
          }
        } else {
          for (var _i23 = 1; _i23 <= btn_len; _i23++) {
            buttons.appendChild(btn[_i23 - 1]);
          }
        }
      }
    }
    ...
    if (document.getElementById("kbtable")) {
      var _table = document.getElementById("kbtable");
      ...
      var _th = _tr[0].getElementsByTagName("th");

      _th[0].className += " thb_t_l";
      _th[_th.length - 1].className += " thb_t_r";
      var _tr_c = _tr[_tr.length - 1].children;
      _tr_c[0].className += " thb_b_l";
      _tr_c[_tr_c.length - 1].className += " thb_b_r";

      if (_table.parentElement.tagName !== "BODY") {
        rateOptimize();
      }

      svgReplacement(_table);
    } //fix a width
    ...
    if (document.getElementById("PagingControl1_btnPrevPage")) {
      var prevbtn = document.getElementById("PagingControl1_btnPrevPage");
      var nextbtn = document.getElementById("PagingControl1_btnNextPage");
      prevbtn.innerHTML = "<";
      nextbtn.innerHTML = ">";
